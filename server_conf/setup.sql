...
CREATE USER 'database_user'@'10.10.20.%' IDENTIFIED WITH mysql_native_password BY 'pr0jectDATA=base';
GRANT ALL PRIVILEGES ON ampache_database.* TO 'database_user'@'10.10.20.%';
